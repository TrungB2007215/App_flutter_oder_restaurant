...
class _RevenueStatisticsOptionsScreenState
  ...
  void initState() {
    ...
    _selectedEvents =
        ValueNotifier(_getEventsForDateRange(_selectedStartDate, _selectedEndDate));
  }
              ...
              ElevatedButton(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(width: 10),
                    Text('Theo Ngày', style: TextStyle(fontSize: 20)),
                  ],
                ),
              ),
              ...
              ElevatedButton(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(width: 10),
                    Text('Theo Nhiều Ngày', style: TextStyle(fontSize: 20)),
                  ],
                ),
              ),
              SizedBox(height: 20),
              ElevatedButton(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(width: 10),
                    Text('Theo Tháng', style: TextStyle(fontSize: 20)),
                  ],
                ),
              ),
              SizedBox(height: 20),
              ElevatedButton(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(width: 10),
                    Text('Theo Năm', style: TextStyle(fontSize: 20)),
                  ],
                ),
              ),
                ...
                Column(
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: Text(
                        DateFormat('MM/yyyy').format(DateTime(_selectedYear, _selectedMonth)),
                        style: TextStyle(fontSize: 20),
                      ),
                    ),
                  ],
              ...
              ElevatedButton(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 8),
                    Text('Xem Thống Kê', style: TextStyle(fontSize: 20)),
                  ],
                ),
              ),
            ],
  ...
  void _selectMonth(BuildContext context) async {
    DateTime? pickedMonth = await showDatePicker(
      context: context,
      initialDate: DateTime(_selectedYear, _selectedMonth), // Sử dụng _selectedMonth và _selectedYear
      firstDate: DateTime(2020),
      lastDate: DateTime(2030),
  ...
  void _viewStatistics() async {
    ...
    switch (_selectedPeriod) {
      case 'Theo Ngày':
        ...
        revenue = await DatabaseHelper().getTotalRevenueForDate(startDate, endDate);

        print('Viewing statistics for $_selectedPeriod: $startDate to $endDate');
      ...
      case 'Theo Nhiều Ngày':
        ...
        if(_selectedStartDate == _selectedEndDate ){
          ...
          DateTime endDate = DateTime(_selectedEndDate.year, _selectedEndDate.month, _selectedEndDate.day, 23, 59, 59);
          ...
          revenue = await DatabaseHelper().getTotalRevenue(startUtc, endOfDay);

          print('Viewing statistics for $_selectedPeriod: $startUtc to $endOfDay');
        }
      ...
      case 'Theo Tháng':
        ...
        endOfMonth = DateTime(endOfMonth.year, endOfMonth.month, endOfMonth.day, 23, 59, 59);
        revenue = await DatabaseHelper().getTotalRevenue(startOfMonth, endOfMonth);
        print('Viewing statistics for $_selectedPeriod: $startOfMonth to $endOfMonth');
        break;

      case 'Theo Năm':
        DateTime startOfYear = DateTime(_selectedYear, 1, 1);
        DateTime endOfYear = DateTime(_selectedYear, 12, 31);
        endOfYear = DateTime(endOfYear.year, endOfYear.month, endOfYear.day, 23, 59, 59);
        revenue = await DatabaseHelper().getTotalRevenue(startOfYear, endOfYear);
        print('Viewing statistics for $_selectedPeriod: $startOfYear to $endOfYear');
        break;
            ...
            children: [
              ...
              if (_selectedPeriod == 'Theo Nhiều Ngày')
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Từ: ${DateFormat('dd/MM/yyyy').format(_selectedStartDate)}'),
                    Text('Đến: ${DateFormat('dd/MM/yyyy').format(_selectedEndDate)}'),
                  ],
                ),
              if (_selectedPeriod == 'Theo Tháng')
                Text('Tháng: ${DateFormat('MM/yyyy').format(DateTime(_selectedYear, _selectedMonth))}'),
              if (_selectedPeriod == 'Theo Năm')
                Text('Năm: ${DateFormat('yyyy').format(_selectedStartDate)}'),
              SizedBox(height: 8),
              Text('Doanh thu: ${NumberFormat.currency(locale: 'vi').format(revenue)}'),
            ],
          ),
          actions: [
            TextButton(
