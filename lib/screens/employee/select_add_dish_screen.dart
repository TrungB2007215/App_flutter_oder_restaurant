...
class SelectAddDishScreen extends StatefulWidget {
  final int tableId;

  SelectAddDishScreen({required this.tableId});

  @override
  _SelectAddDishScreenState createState() => _SelectAddDishScreenState();
}

class _SelectAddDishScreenState extends State<SelectAddDishScreen> {
  ...
  Future<void> _addDishesToTable() async {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Món đã thêm thành công'),
          actions: [
            ElevatedButton(
              onPressed: () {
